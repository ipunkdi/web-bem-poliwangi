...
@section('content')
    ...
    <div class="grid lg:grid-cols-4 md:grid-cols-2 gap-8 px-4 my-12">
        <div class="bg-gray-100 p-6 rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" class="w-12 mb-4 inline-block bg-white p-3 rounded-md"
                viewBox="0 0 32 32">
                <path
            ...
            <a href="javascript:void(0);" class="text-blue-600 font-bold inline-block text-sm mt-2 hover:underline">Learn
                more</a>
        </div>
        <div class="bg-gray-100 p-6 rounded-md">
            <svg xmlns="http://www.w3.org/2000/svg" fill="#007bff" class="w-12 mb-4 inline-block bg-white p-3 rounded-md"
