...
@section('content')
    <div class="pb-10 bg-slate-200">
        ...
        <div
            ...
            <img src="{{ asset('image/fotbar.png') }}" alt="Banner Image"
            ...
            <div
                ...
                <div class="bg-black/25 text-start rounded-md py-2 px-2 ">
                    ...
                    <p class="sm:text-lg text-base text-center text-gray-200">Embark on unforgettable journeys. Book your
                        dream
                        vacation today!</p>
                </div>
            </div>
        ...
        <div class="px-4 mb-40 sm:px-10">
            <div class="mt-32 max-w-7xl mx-auto">
                <div class="mb-16 max-w-2xl text-center mx-auto">
                    <h2 class="md:text-4xl text-3xl font-extrabold mb-6">Apa Itu Badan Eksekutif Mahasiswa?</h2>
                    <p class="mt-6">BEM Atau Badan Eksekutif Mahasiswa Adalah Organisasi Intra
                        Kampus Yang Mewakili Mahasiswa Dalam Mengelola dan Memperjuangkan
                        Kepentingan Mereka di Tingkat Institusi, Apa Saja Perannya?</p>
                </div>
                <div class="grid lg:grid-cols-2 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
                    <div class="sm:p-6 p-4 flex bg-white rounded-md border shadow-[0_14px_40px_-11px_rgba(93,96,127,0.2)]">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold mb-2">Menjadi sarana pengembangan mahasiswa</h3>
                            <p>Sebagai lembaga perwakilan, BEM memiliki tujuan agar mahasiswa dapat mengembangkan diri yang
                                akan berguna bagi masa depan kelak</p>
                        </div>
                    </div>
                    <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold mb-2">Sebagai Agen Perubahan</h3>
                            <p>Salah satu fungsi BEM adalah sebagai agen perubahan. Melalui ide, gagasan, kerja sama,
                                pengetahuan, dan keterampilannya, anggota BEM mampu untuk membawa perubahan ke arah yang
                                lebih baik.</p>
                        </div>
                    </div>
                    <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                        ...
                        <div>
                            <h3 class="text-xl font-semibold mb-2">Menciptakan kesejahteraan mahasiswa di kampus</h3>
                            <p>Dengan adanya BEM diharapkan dapat tercipta kesejahteraan bagi mahasiswa di lingkungan kampus
                                serta tidak ada lagi kesenjangan sosial yang dialami mahasiswa.</p>
                        </div>
                    </div>
                    <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                        ...
                        <div>
                            <h3 class="text-xl font-semibold mb-2">Sebagai Fasilitator</h3>
                            <p>BEM adalah sarana penghubung antara mahasiswa dan pihak kampus. Dengan adanya organisasi ini,
                                mahasiswa bisa menyampaikan aspirasi demi mewujudkan kesejahteraan di kampus.</p>
                        </div>
                    </div>
                </div>
                <div class="mb-16 max-w-2xl text-center mx-auto mt-32">
                    <h2 class="md:text-4xl text-3xl font-extrabold mb-6">Visi</h2>
                    <p class="mt-6">“Menjadikan BEM KM POLIWANGI yang bersinergi inovatif dan solutif dalam merespon
                        aspirasi serta melindungi hak-hak mahasiswa serta menjujung tinggi nilai-nilai transparansi dan
                        akuntabilitas dalam setiap tindakan dan keputusan BEM KM POLIWANGI”</p>
                </div>
                <div class="mb-16 max-w-2xl text-center mx-auto w-full">
                    <h2 class="md:text-4xl text-3xl font-extrabold mb-6">Misi</h2>
                    <p class="mt-6">
                        1. Merangkul seluruh organisasi yang ada di dalam lingkungan kampus POLIWANGI guna mempererat
                        hubungan, komunikasi dan kolaborasi antar organisasi kemahasiswaan.</p>
                    <p>2. Meningkatkan kesadaran dan kepekaan BEM KM POLIWANGI terhadap kebutuhan mahasiswa di lingkungan
                        kampus, dengan tujuan memberikan layanan yang optimal dan berkelanjutan.</p>
                    <p>3. Menjadikan BEM KM POLIWANGI sebagai wadah yang efektif, selektif, dan aktif merespon serta
                        merealisasikan aspirasi dan hak-hak mahasiswa.</p>
                    <p>4. Menciptakan BEM KM POLIWANGI yang inovatif, dengan berfokus pada pengembangan program-program
                        berkualitas, serta menjunjung tinggi nilai-nilai transparansi dan akuntabilitas dalam setiap
                        tindakan dan keputusan BEM KM POLIWANGI.</p>
                </div>
            </div>
        ...
        <div class="mt-32">
            ...
            <div class="grid md:grid-cols-3 md:py-16 gap-8 max-w-7xl max-md:max-w-lg mx-auto relative">
                <div
                    class="bg-gray-100 lg:max-w-[70%] max-w-[80%] h-full w-full inset-0 mx-auto rounded-3xl absolute max-md:hidden">
                </div>
