...
@section('container')
        ...
        <div class="relative p-4 w-full max-w-md h-full md:h-auto">
            ...
            <div class="relative p-4 text-center bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                ...
                <div class="flex justify-center items-center space-x-4">
                    ...
                    <form action="/dashboard/kastrats/{{ $kementerian->id }}" method="POST">
                        @method('delete')
                        @csrf
                        <button type="submit"
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse px-4 lg:px-12">
            ...
            <li>
                <div class="flex items-center">
                    ...
                    <a href="/dashboard/kastrats/{{ $kementerian->name }}"
    ...
    {{-- Title --}}
    <h3 class="text-3xl mb-5 font-bold dark:text-white mt-2 px-4 lg:px-12">{{ $kementerian->name }}</h3>

    <section class="bg-white dark:bg-gray-900 mx-12">
        <div class="py-8 px-4 mx-20 max-w-2xl lg:py-16">
            <div style="max-height: 350px; overflow:hidden">
                <img src="{{ asset('storage/' . $kementerian->image) }}" alt="{{ $kementerian->name }}"
                    class="img-fluid mt-3">
            </div>
            <h2 class="my-5 text-xl font-semibold leading-none text-gray-900 md:text-2xl dark:text-white">
                {{ $kementerian->name }}</h2>
            <dl>
                <dt class="mb-2 font-semibold leading-none text-gray-900 dark:text-white">Deskripsi</dt>
                <article class="mb-4 text-sm text-gray-500 sm:mb-5 dark:text-gray-400">{!! $kementerian->description !!}</article>
            </dl>
            <div class="flex items-center space-x-4">
                ...
                <button id="AlertModal" type="button"
