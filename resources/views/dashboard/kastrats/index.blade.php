            ...
            <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg">
                <div class="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
                    ...
                    <div
                        ...
                        <a href="/dashboard/kastrats/create"
                        ...
                        <tbody>
                            @foreach ($kastrats as $kastrat)
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <img src="{{ asset('storage/' . $kastrat->image) }}" alt="{{ $kastrat->title }}"
                                            style="height: 2.5rem;"
                                    ...
                                    <td class="px-4 py-3 flex items-center justify-end">
                                        <button id="{{ $kastrat->id }}-dropdown-button"
                                            data-dropdown-toggle="{{ $kastrat->id }}-dropdown"
                                        ...
                                        <div id="{{ $kastrat->id }}-dropdown"
                                            class="hidden z-10 w-44 h-fit bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                            <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                aria-labelledby="{{ $kastrat->id }}-dropdown-button">
                                                <li>
                                            ...
                                            <div class="relative p-4 w-full max-w-md h-full md:h-auto">
                                                ...
                                                <div
                                                    ...
                                                    <div class="flex justify-center items-center space-x-4">
                                                        ...
                                                        <form action="/dashboard/kastrats/{{ $kastrat->slug }}"
                                                            method="POST">
                                                            @method('delete')
                                                            @csrf
                                                            <button type="submit"
                ...
                <nav class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
                    ...
                    <span class="text-sm font-normal text-gray-500 dark:text-gray-400">
                        Showing
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $kastrats->firstItem() }} to
                            {{ $kastrats->lastItem() }}</span>
                        of
                        <span class="font-semibold text-gray-900 dark:text-white">{{ $kastrats->total() }}</span>
                    </span>
                    <ul class="inline-flex items-stretch -space-x-px">
                        <li>
                            <a href="{{ $kastrats->previousPageUrl() }}"
